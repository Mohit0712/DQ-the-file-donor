...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "https://t.me/BhootBazar/132")
VERIFY2_URL = environ.get('VERIFY2_URL', "Earn4share.online")
VERIFY2_API = environ.get('VERIFY2_API', "5d6505709fb29c5d45cd44c9fe75ba6c913252b8")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'Earn4share.online')
SHORTLINK_API = environ.get('SHORTLINK_API', '5d6505709fb29c5d45cd44c9fe75ba6c913252b8')
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'False')), False)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+CahQdx1F0Y5hMDU9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+6nR1YgXPHXk3MTdl')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+6nR1YgXPHXk3MTdl')
